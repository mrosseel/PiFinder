...
class CameraPI(CameraInterface):
    ...
    def _read_raw(self) -> np.ndarray:
        ...
        # Per-frame optical-black pedestal, measured from this frame's driver
        # metadata. Published on self because the read and the crop-side
        # radiometer sample that consumes it are separate steps.
