...
def build_geometry(
    ...
    # --- solve pipeline ---
    bin_factor = profile.solve_bin_factor
    solve = _scale(1.0 / bin_factor, 1.0 / bin_factor)
    rot, width, height = _rot90_ccw(
        raw_width // bin_factor, raw_height // bin_factor, profile.rotation_90
    )
    solve = rot @ solve
